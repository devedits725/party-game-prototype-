        ...
        <div style={{
          ...
          <div>
            ...
            <div className="card" style={{ marginBottom: 16, fontSize: 13, color: 'var(--muted)' }}>
              ...
              {game !== 'fighter' && (
                <span>Players use their phones to interact</span>
              )}

              <div style={{ marginTop: 8 }}>
                Gamepad: Xbox, PS, Switch Pro — all supported
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                color: 'white',
                opacity: players.length < meta.min ? 0.5 : 1
              }}
              disabled={players.length < meta.min}
              onClick={startGame}
            >
              {players.length < meta.min
                ? `Need ${meta.min - players.length} more`
                : `Start ${meta.name}! 🚀`}
            </button>
          </div>
